        ...
        if (error) {
          ...
          userProvider.getUserByCredentials(req, creds, function(error, user) {
            if (error) {
              ...
              userProvider.refreshUserData(user, twitterProvider, githubProvider, foursquareProvider, function(error, user) {
                var actions = [];
                if(user.actions) {
                  ...
                  actions = df.processAndSortActions(user.tzo, actions);
                }
